...
global.fetch = async (url, opts = {}) => {
  ...
  /**
   * NO YouTube API STUBS. The OAuth token exchange, the Analytics reports and
   * the Data API title lookup were removed with the code path in v3.129.0.
   *
   * Left as a note rather than deleted silently: a stub for a path that no
   * longer exists is how a reviewer concludes the path is still there. If any
   * of those URLs is ever requested again it now falls through to the
   ...
   *   - CART VALUE: Instagram PAID MORE than it carted (a cart from June).
  ...
  if (u.includes("17T21LhWM")) {
    ...
    if (/(%27|')Shopee(%20|\+| )Ads(%27|')/.test(u)) {
      ...
      return jsonRes({ spreadsheetId: "mock-shopee", valueRanges: [{ values: [
        ...
        // April: only the first 10 days pasted, 200 credited a day — the
        // trend keeps April (Sales covers it) but flags 10 of 30 ad days.
        ...Array.from({ length: 10 }, (_, i) => ar(`${String(i + 1).padStart(2, "0")}/04/2026`, "TH", "100", "1", 0, "200", "10")),
      ] }] });
    }
    ...
    return jsonRes({ spreadsheetId: "mock-shopee", valueRanges: [
      { values: [SH.slice(0, 10),
        ...
        // ORGANIC TREND (v3.341.0): every day of April 2026, 1,000 a day.
        ...Array.from({ length: 30 }, (_, i) => [`${String(i + 1).padStart(2, "0")}-04-2026`, "100", "1", "1", "1", "1,000", "1%",
          "1", "1", "1", "1,000", "1,000.00", "1%", "100%"])] },
    ...
    if (u.includes(encodeURIComponent("Summary")) && u.includes(encodeURIComponent("Rev_Attribution"))) {
      ...
      const detail = [
        ["MonthYear","HN_ID","Revenue","Segment","Returned2Y","SourceTab","LoadedAt","User ID","Nationality"],
        ["2026-05","aaa1",10000,"Old","","t","x","u1",""],
        ["2026-05","aaa2",5000,"New","","t","x","u2",""],
        ["2026-05","aaa3",20000,"Old","Y","t","x","u3",""],
        ["2026-05","",5000,"Old","","t","x","",""],          // pre-scrubbed: revenue only
        ["2026-06","bbb1","8,000","New","","t","x","u4",""],
        ["2026-06","bbb2",4000,"New","","t","x","u5",""],
        ["2026-06","aaa1",30000,"Old","","t","x","u1",""],
        ["2026-06","aaa3",4000,"Old","Y","t","x","u3",""],
        ["2026-06","aaa2",4000,"Old","","t","x","u2",""],
        ["2026-07","bbb1",6000,"Old","","t","x","u4",""],          // June cohort returns
        ["2026-07","ccc1",10000,"New","Y","t","x","u7",""],
        ["2026-07","ccc2",6000,"New","","t","x","u8",""],
        ["2026-07","aaa1","40,000","Old","","t","x","u1",""],
        ["2026-07","aaa3",3000,"Old","Y","t","x","u3",""],
        ["2026-07","aaa2",1000,"Old","","t","x","u2",""],
        [],
      ];
